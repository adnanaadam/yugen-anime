    ...
    <div className="flex flex-col items-center gap-8 w-full max-w-sm">
      ...
      <div className="flex flex-col gap-3 w-full">
        <button
          ...
          className="flex items-center justify-center gap-3 w-full rounded-lg border px-4 py-3 text-sm font-medium transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-900"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 w-full rounded-lg bg-[#5865F2] px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
        >
      ...
      <p className="text-sm text-zinc-500">
        ...
        <a href="/signin" className="text-zinc-900 underline dark:text-zinc-50">
          Sign in
        </a>
      </p>
    </div>
